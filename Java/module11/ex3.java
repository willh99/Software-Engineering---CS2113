// File: ex3.java (Module 11)
//
// Author: Rahul Simha
// Created: November 10, 1998.
//
// Template for Ex. 11.3
// Using a List instead of a Choice in Q4 of the survey form.
...
class NewFrame extends JFrame {
	...
	// ADD YOUR CODE HERE
	String [] movieStrings = {"Star Wars", "Titianic", "Planet of the Apes"};
	...
	movieList.addActionListener(new ActionListener() {
		...
		String movieName = (String)cb.getSelectedItem();
		for(int i=0; i<movieStrings.length; i++){
		    if(movieStrings[i].equals(movieName)){
			if(movieStrings[i].equals("Star Wars") )
			    q4Score = 3;
			else
			    q4Score =0;
		    }
